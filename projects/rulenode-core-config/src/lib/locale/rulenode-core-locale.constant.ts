    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'client-attributes': 'Client attribute keys',
          'shared-attributes': 'Shared attribute keys',
          'server-attributes': 'Server attribute keys',
          ...
          'use-cashing-tooltip': 'Rule node will cache the value of "pulseCounter" that arrives from the incoming message to improve performance. Note that the cache will not be updated if you modify the "pulseCounter" value elsewhere.',
          'add-time-difference-between-readings': 'Add the time difference between "PulseCounter" readings',
          'add-time-difference-between-readings-tooltip': 'If enabled, the rule node will add the "periodInMs" to the outbound message.',
