    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'argument-type-field-input': 'Argument type',
          'argument-type-field-input-required': 'Argument type is required.',
          'argument-key-field-input': 'Argument key',
          ...
          'add-to-body-field-input': 'Add to body',
          'add-to-metadata-field-input': 'Add to metadata',
          'custom-expression-field-input': 'Custom expression',
          'custom-expression-field-input-required': 'Custom expression is required',
        },
        'key-val': {
          key: 'Key',
          value: 'Value',
