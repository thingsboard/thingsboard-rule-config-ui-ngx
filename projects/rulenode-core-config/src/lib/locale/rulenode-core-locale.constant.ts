    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'forward-msg-default-rule-chain-tooltip': 'If enabled, message will be forwarded to the originator\'s default rule chain. Forwarding messages to the current rule chain is not allowed.',
