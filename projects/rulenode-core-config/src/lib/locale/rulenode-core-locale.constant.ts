    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'client-attributes': 'Client attribute',
          'shared-attributes': 'Shared attribute',
          'server-attributes': 'Server attribute',
          ...
          'start-interval-pattern': 'Interval start pattern',
          'end-interval-pattern': 'Interval end pattern',
          'start-interval-pattern-required': 'Interval start pattern is required!',
          'end-interval-pattern-required': 'Interval end pattern is required!',
          ...
          'use-metadata-interval-patterns-tooltip': 'If selected, the rule node will use dynamic interval start and end based on the message and pattern.',
