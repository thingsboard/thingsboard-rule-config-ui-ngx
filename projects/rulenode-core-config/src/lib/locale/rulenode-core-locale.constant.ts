    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'originator-entity-by-name-pattern-desc': 'Use entity fetched from DB by type and specified name pattern as new originator.',
        ...
        'key-val': {
          ...
          'unique-key-value-pair-error': '\'Key name\' must be different from the current \'Name\'',
        },
        'mail-body-type': {
          ...
          'dynamic-text-description':
              'Ability to use Plain Text or HTML format dynamically on message or message metadata templatization feature.',
        }
      }
    };
