    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'kv-map-pattern-hint': 'All input fields support templatization. Use ${messageKey} to extract value from the message body ${metadataKey} to extract value from the message metadata.',
