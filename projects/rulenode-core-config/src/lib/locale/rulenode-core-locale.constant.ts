    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'update-attributes-on-value-change':'Update on value change',
          'update-attributes-on-value-change-hint': 'Update the attribute only if its value has changed from the previous state.',
