    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'send-attributes-updated-notification-hint': 'Enable this setting to send attributes updated notification to the message originator root rule chain.',
          'send-attributes-deleted-notification': 'Send attributes deleted notification',
          'send-attributes-deleted-notification-hint': 'Enable this setting to send attributes deleted notification to the message originator root rule chain.',
