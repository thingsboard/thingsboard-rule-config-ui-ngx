    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'fetch-parameter-info-from-metadata-hint': 'Metadata field \'{{perimeterKeyName}}\' should be defined in next formaat: {"latitude":48.196, "longitude":24.6532, "radius":100.0, "radiusUnit":"METER"}',
