    ...
    const enUS = {
      tb: {
        rulenode: {
          ...
          'max-relation-level-error': 'Max relation level should be greater than 0 or unspecified!',
          ...
          'originator-fields-sv-map-hint': 'Target key support templatization. Use ${messageKey} to extract value from the message body and ${metadataKey} to extract value from the message metadata.',
          'sv-map-hint': 'Only target key support templatization. Use ${messageKey} to extract value from the message body and ${metadataKey} to extract value from the message metadata.',
          ...
          'use-cashing-tooltip': 'Rule node will cache the value of "{{inputValueKey}}" that arrives from the incoming message to improve performance. Note that the cache will not be updated if you modify the "{{inputValueKey}}" value elsewhere.',
          ...
          'fetch-latest-telemetry-with-timestamp-tooltip': 'If selected, latest telemetry values will be added to the outbound message metadata with timestamp, e.g: "{{latestTsKeyName}}": "{"ts":1574329385897, "value":42}"',
        ...
        'key-val': {
          ...
          'add-mapping-entry': 'Add mapping entry',
          'add-entry': 'Add entry',
